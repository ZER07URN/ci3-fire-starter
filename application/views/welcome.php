...
<p>Click <a href="<?=base_url( 'api/users' );?>">HERE</a> to view sample API output of users. This is for demo purposes only! Be sure to remove the users API before putting your site in a production environment.</p>

<div class="clearfix"><hr /></div>

<p>Click <a href="<?=base_url( 'profile' );?>">HERE</a> to view a sample user profile.</p>
<p>
...
<p>Click <a href="<?=base_url( 'admin' );?>">HERE</a> to view the admin interface.</p>
<p>
